...
Board.prototype.isOldArduinoDevice = function () {
  return /usbserial|USB/.test(this.port);
};
...
Board.prototype._data = function (data) {
  var byt, cmd;
  ...
  for (var i = 0; i < data.length; i++) {
    ...
    if (this.currentBuffer[0] === START_SYSEX &&
      ...
      if (SYSEX_RESPONSE[this.currentBuffer[1]]) {
        SYSEX_RESPONSE[this.currentBuffer[1]](this);
      } else {
        this.emit("sysex", this.currentBuffer[1], this.currentBuffer.slice(2, this.currentBuffer.length - 1), this);
      }

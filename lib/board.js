...
Board.prototype.connect = function (port, opts, callback) {
  ...
  opts = opts || {};
  this.port = port || opts.port || this.port;
  ...
  this.transport.once('open', function () {
    ...
    var cid = setInterval(function () {
      if (that.versionReceived === false && that.transport.isOpen()) {
...
Board.prototype.close = function (callback) {
  // clear versionReceived for reconnect
  this.versionReceived = false;
...
Board.prototype.send = function (cmd, data, cb) {
  ...
  buf.push(END_SYSEX);
  debug('[Firmata] Sent', data.length);
